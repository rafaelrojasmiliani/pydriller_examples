...
5. Extract commit-level stats (files changed, insertions, deletions) and export to CSV.
6. Build a map keyed by file path where each value is the list of commits that modified that file.
